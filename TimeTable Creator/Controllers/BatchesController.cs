...
namespace TimeTable_Creator.Controllers
{
    public class BatchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,TimeStamp,studentCount,Description,code")] Batch batch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,TimeStamp,studentCount,Description,code")] Batch batch)
        {
            if (id != batch.Id)
            {
                return NotFound();
